...
<head>
    ...
    <title>Register - Joshi Trading Pro</title>
...
<div class="glass-panel login-card reveal active">
    ...
    <form method="POST" action="register.php">
        <div class="form-group">
            <label for="full_name" style="color: #cbd5e1;">Full Name</label>
            <input type="text" id="full_name" name="full_name" class="form-control" placeholder="Enter your full name" required autofocus>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="confirm_password" style="color: #cbd5e1;">Confirm Password</label>
        ...
        <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: 1.5rem; border-radius: 8px;">Register</button>
    </form>
    
    <div style="text-align: center; margin-top: 1.5rem; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 1.5rem;">
        <p style="color: #cbd5e1; font-size: 0.9rem; margin-bottom: 0.5rem;">Already have an account?</p>
        <a href="login.php" style="color: var(--electric-gold); font-weight: 600;">Sign in here</a>
    </div>
